...
3. Organ / System Affinity — **EHAS2 current:** **Organ-System Affinity Engine** / machine identity **`ORGAN_SYSTEM_AFFINITY`** (owner-locked; historical EH_9 / Phase 5B short alias retained above; approved UI **Rule 3 — Active Organ Systems**)
4. Potency
...
**EHAS2 Rule 2 authority:** identity/scope owner-locked (`POLARITY_ENGINE`); focused canonical contract: [rules/rule-02-polarity-engine-contract.md](./rules/rule-02-polarity-engine-contract.md) (`R2_ID01_TO_ID05_RECOMMENDED_DECISIONS_APPROVED`). Post-merge synthetic shadow evidence: [rules/rule-02-polarity-engine-implementation-evidence.md](./rules/rule-02-polarity-engine-implementation-evidence.md) (`RULE2_SHADOW_EVALUATOR_IMPLEMENTED`, PR #101). Package `@ehas2/rule2` / `evaluateRule2Shadow`. Technical `READY_FOR_VALIDATION` · `affectsClinicalSelection: false` · mappings **0** · catalog **NOT_CREATED** · registry empty/fail-closed · formula mutation **NONE** · medicine influence **NONE** · Rule 4 **not** connected · orch **NOT_CONNECTED** · activation/Rx **NONE**. Frozen clinical body: [rules/rule-02-polarity-engine.md](./rules/rule-02-polarity-engine.md). Historical matrix rows describing legacy selection coerce remain **LEGACY_REFERENCE_ONLY** and do not override this contract.

**EHAS2 Rule 3 authority:** identity/scope owner-locked (`ORGAN_SYSTEM_AFFINITY`); focused canonical contract: [rules/rule-03-organ-system-affinity-contract.md](./rules/rule-03-organ-system-affinity-contract.md) (`R3_ID01_TO_ID05_RECOMMENDED_DECISIONS_APPROVED`). Post-merge synthetic shadow evidence: [rules/rule-03-organ-system-affinity-implementation-evidence.md](./rules/rule-03-organ-system-affinity-implementation-evidence.md) (`RULE3_SHADOW_EVALUATOR_IMPLEMENTED`, PR #104). Package `@ehas2/rule3` / `evaluateRule3Shadow`. Technical `READY_FOR_VALIDATION` · `affectsClinicalSelection: false` · mappings **0** · catalog **NOT_CREATED** · no closed real organ-system catalog · empty registry fail-closed · medicine influence **NONE** · formula mutation **NONE** · Rule 4 **not** connected · orch **NOT_CONNECTED** · activation/Rx **NONE**. Frozen clinical body: [rules/rule-03-organ-system-affinity.md](./rules/rule-03-organ-system-affinity.md). Historical matrix rows describing legacy keyword / METABOLIC fallback remain **LEGACY_REFERENCE_ONLY** and do not override this contract. Dashboard short alias “Organ / System Affinity” remains historical/non-authoritative.
...
| 2 Polarity Engine | **EHAS2 canonical contract:** [rules/rule-02-polarity-engine-contract.md](./rules/rule-02-polarity-engine-contract.md) (`POLARITY_ENGINE`, owner-locked, `R2_ID01_TO_ID05_RECOMMENDED_DECISIONS_APPROVED`). **Post-merge synthetic shadow evidence:** [rules/rule-02-polarity-engine-implementation-evidence.md](./rules/rule-02-polarity-engine-implementation-evidence.md) (`RULE2_SHADOW_EVALUATOR_IMPLEMENTED`, PR #101). Package `@ehas2/rule2` / `evaluateRule2Shadow`. Frozen clinical spec (body preserved): [rules/rule-02-polarity-engine.md](./rules/rule-02-polarity-engine.md). Legacy row (reference only): `formula_polarity_policy_engine` / `detect_polarity` | Canonical shadow inputs per contract; legacy: slot/case context | Shadow polarity annotations / fail-closed outcomes per contract; legacy: POSITIVE/NEGATIVE/MIXED/UNRESOLVED | **Shadow-only**; medicine-selection influence **NONE**; formula mutation **NONE**; Rule 4 **not** connected; orchestration **NOT_CONNECTED**; clinical activation **NONE**; prescription effect **NONE**; real mappings **0**; catalog **NOT_CREATED** | Empty registry fail-closed; MIXED → UNRESOLVED + NEUTRAL therapeutic + doctor review | P01–P18 + regressions on main (PR #101) | EHAS2: keep shadow annotation-only; deprecate legacy dual coerce path |
| 3 Organ-System Affinity Engine | **EHAS2 canonical contract:** [rules/rule-03-organ-system-affinity-contract.md](./rules/rule-03-organ-system-affinity-contract.md) (`ORGAN_SYSTEM_AFFINITY`, owner-locked, `R3_ID01_TO_ID05_RECOMMENDED_DECISIONS_APPROVED`). **Post-merge synthetic shadow evidence:** [rules/rule-03-organ-system-affinity-implementation-evidence.md](./rules/rule-03-organ-system-affinity-implementation-evidence.md) (`RULE3_SHADOW_EVALUATOR_IMPLEMENTED`, PR #104). Package `@ehas2/rule3` / `evaluateRule3Shadow`. Frozen clinical spec (body preserved): [rules/rule-03-organ-system-affinity.md](./rules/rule-03-organ-system-affinity.md). Legacy row (reference only): `integrated_engine.detect_systems` / `detect_active_systems` | Canonical shadow inputs per contract; legacy: symptoms, gender, CC | Shadow organ/system annotations / fail-closed outcomes per contract; legacy: systems + details | **Shadow-only**; medicine-selection influence **NONE**; formula mutation **NONE**; Rule 4 **not** connected; orchestration **NOT_CONNECTED**; clinical activation **NONE**; prescription effect **NONE**; real mappings **0**; catalog **NOT_CREATED**; no closed real organ-system catalog | Empty registry fail-closed; **no** automatic METABOLIC fallback; unresolved → empty active + `INSUFFICIENT_ORGAN_SYSTEM_EVIDENCE` | P01–P18 + R01–R08 on main (PR #104) | EHAS2: identity/scope/contract documented · synthetic shadow **IMPLEMENTED** · technical `READY_FOR_VALIDATION` · `affectsClinicalSelection: false` · empty registry fail-closed · independent of Rule 5 C3E; legacy “plans + boosts” = LEGACY_REFERENCE_ONLY |
