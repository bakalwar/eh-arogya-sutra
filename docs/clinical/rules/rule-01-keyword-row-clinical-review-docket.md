...
| Mixed temperament handling | Governed by R1-OD-03 · algorithm completed by `OWNER-FREEZE-OD-R1-IMPL-01-v1` (deduped scores → deterministic **100.0%**; ≥2 independent concepts; zero → INSUFFICIENT; equal top → UNRESOLVED_TIE) — see [rule-01-implementation-boundary-owner-freeze-OD-R1-IMPL-01-06.md](./rule-01-implementation-boundary-owner-freeze-OD-R1-IMPL-01-06.md) |
