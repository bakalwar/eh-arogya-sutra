...
| Field | Value |
|-------|--------|
| **Authority** | Owner row review — **all 37 legacy keyword rows owner-approved** (Bilious 8 + Sanguine 10 + Lymphatic 11 + Nervous 8) |
...
Owner decision columns: **Bilious Batch 1 (8) + Sanguine Batch 2 (10) + Lymphatic Batch 3 (11) + Nervous Batch 4 (8) owner-approved** — see [rule-01-bilious-batch1-owner-approval-freeze.md](./rule-01-bilious-batch1-owner-approval-freeze.md) · [rule-01-sanguine-batch2-owner-approval-freeze.md](./rule-01-sanguine-batch2-owner-approval-freeze.md) · [rule-01-lymphatic-batch3-owner-approval-freeze.md](./rule-01-lymphatic-batch3-owner-approval-freeze.md) · [rule-01-nervous-batch4-owner-approval-freeze.md](./rule-01-nervous-batch4-owner-approval-freeze.md). **0 rows remain blank.** Documentation approval is **not** runtime activation.
...
**Status:** **Owner approved** — see [rule-01-nervous-batch4-owner-approval-freeze.md](./rule-01-nervous-batch4-owner-approval-freeze.md) · token `OWNER-FREEZE-R1-NERVOUS-BATCH4-v1` · all eight raw weights **0**
...
| Mixed temperament handling | Governed by R1-OD-03 · algorithm by `OWNER-FREEZE-OD-R1-IMPL-01-v1` + correction `OWNER-FREEZE-OD-R1-IMPL-01-CORR-v1` (`RULE1_PERCENTAGE_HAMILTON_V1`, sum **100.0**; ≥2 concepts; zero → INSUFFICIENT; equal top → UNRESOLVED_TIE; no singular secondary) · thermal scope `OWNER-FREEZE-OD-R1-IMPL-05-CORR-v1` — see [rule-01-implementation-boundary-owner-freeze-OD-R1-IMPL-01-06.md](./rule-01-implementation-boundary-owner-freeze-OD-R1-IMPL-01-06.md) |
...
| Nervous rows owner-approved | **8** (`R1-KW-0020` … `R1-KW-0027`; raw weights **0**) |
| Remaining rows unapproved | **0** |
...
| `owner_approved_weight` | Populated on **37** approved rows (all batches; many raw weights are **0**) |
...
- `RULE1_ROW_OWNER_DECISIONS_37_OF_37`
