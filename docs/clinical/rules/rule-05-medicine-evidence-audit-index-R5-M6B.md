...
|--------|------:|
| Total medicines | 38 |
| Completed documentation audits | 26 |
| In progress | 0 |
| Next eligible medicine in canonical sequence | **S2** — `NOT_STARTED`; informational only; separate owner authorization required |
...
| Documentation audits completed | 26 (A1, A2, A3, APP, BE, C1, C2, C3, C4, C5, C6, C10, C13, C15, C17, F1, F2, GE, L1, P1, P2, P3, P4, RE, S-Lass, S1) |
...
| Next eligible in sequence (not an audit target) | S2 — NOT_STARTED |
