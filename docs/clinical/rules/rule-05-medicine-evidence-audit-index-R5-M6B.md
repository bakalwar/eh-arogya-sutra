...
|--------|------:|
| Total medicines | 38 |
| Completed documentation audits | 10 |
| In progress | 0 |
| Next eligible medicine in canonical sequence | **C6** — `NOT_STARTED`; separate owner authorization required |
...
| Documentation audits completed | 10 (A1, A2, A3, APP, BE, C1, C2, C3, C4, C5) |
...
| Next eligible in sequence (not an audit target) | C6 — NOT_STARTED |
...
**Authority tag:** DOCUMENTATION_ONLY_AUDIT_INDEX · **A1–BE, C1, C2, C3, C4, and C5 audit records linked; C1/C2/C3/C4/C5 provisional primary; C3/C4/C5 RECORDED_0; APP/BE owner-primary not located; no clinical validation**
