    ...
    def test_python_registry_parity_with_fixtures(self) -> None:
        ...
        phase5 = json.loads(
            (
                ...
                / "fixtures"
                / "rule4"
                / "reason-code-registry.phase5-structured-phase-subset.v1.json"
        ...
        phase6 = json.loads(
            (
                ...
                / "fixtures"
                / "rule4"
                / "reason-code-registry.phase6-structured-severity-subset.v1.json"
            ).read_text(encoding="utf-8")
        )
        phase7 = json.loads(
            (
        ...
        phase9 = json.loads(
            (
                ...
                / "fixtures"
                / "rule4"
                / "reason-code-registry.phase9-pediatric-overlay-subset.v1.json"
            ).read_text(encoding="utf-8")
        )
        phase10 = json.loads(
            (
                ...
                / "fixtures"
                / "rule4"
                / "reason-code-registry.phase10-doctor-review-issuance-subset.v1.json"
            ).read_text(encoding="utf-8")
        )
        reason_codes = sorted(
            r["code"]
