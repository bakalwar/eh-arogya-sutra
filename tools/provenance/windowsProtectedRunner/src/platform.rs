//! Provenance: adapted from C3C windowsHandleSpike/src/platform.rs (RtlGetVersion Win11 x64 gate).
...
pub fn require_windows11_x64() -> Result<(), RunnerCode> {
    #[cfg(not(windows))]
    {
        return Err(RunnerCode::UnsupportedPlatform);
    }
    #[cfg(windows)]
    {
