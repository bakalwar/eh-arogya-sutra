...
const workspaceDirs = {
  ...
  '@ehas2/evidence-ingest': 'packages/evidence-ingest',
  '@ehas2/evidence-extract': 'packages/evidence-extract',
  '@ehas2/evidence-extract-adapters': 'packages/evidence-extract-adapters',
  '@ehas2/clinical-contracts': 'packages/clinical-contracts',
  '@ehas2/rule1': 'packages/rule1',
  '@ehas2/rule2': 'packages/rule2',
  '@ehas2/rule3': 'packages/rule3',
  '@ehas2/rule6': 'packages/rule6',
  '@ehas2/rule7': 'packages/rule7',
  '@ehas2/rule8': 'packages/rule8',
  '@ehas2/rule9': 'packages/rule9',
  '@ehas2/clinical-data-manifest': 'packages/clinical-data-manifest',
  '@ehas2/disease-identity': 'packages/disease-identity',
