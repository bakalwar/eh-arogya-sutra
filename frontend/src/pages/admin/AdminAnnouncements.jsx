    ...
    <div className="mx-auto w-full max-w-5xl space-y-6 pb-12">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <h1 className="mt-1 font-display text-xl font-semibold text-white">📣 Announcements</h1>
          <p className="mt-1 text-sm text-white/40">Push notifications and alerts to all doctors</p>
        </div>
      ...
      <div className="rounded-2xl border border-white/[0.07] bg-white/[0.02] p-10 text-center">
        ...
        <div className="font-display text-lg text-white/70 mb-2">Announcements</div>
        <div className="text-sm text-white/35 max-w-md mx-auto">Push notifications and alerts to all doctors</div>
